...
async function handleSimpanSurat(event, modul) {
    ...
    try {
        ...
        if (modul === 'masuk') {
            ...
            // --- LOGIKA DISPOSISI ---
            let disposisiArr = [];
            // Ambil semua yang dicentang (kecuali checkbox 'Semua' dan 'Lainnya')
            document.querySelectorAll('.cb-disposisi:checked').forEach(cb => {
                disposisiArr.push(cb.value);
            });
            // Ambil teks dari 'Lainnya' jika dicentang
            ...
            // --- PERUBAHAN DI SINI ---
            // Jika ada yang dicentang, gabungkan. Jika kosong, kirim tanda strip (-)
